...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", type=str, default="./imgs/output/69918_stylegan3.png",
                        help="The path to save the inversion images. (default: images_dir)")
    parser.add_argument("--ckpt",  type=str, default="./weights/e4e_ffhq_encode_stylegan3.pt", help="path to generator checkpoint")
